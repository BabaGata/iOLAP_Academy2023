...
args = getResolvedOptions(sys.argv, ["JOB_NAME", "GlueDatabaseLandingName", "S3BucketData"])
sc = SparkContext()
...
DATABASE_LANDING = args["GlueDatabaseLandingName"]
S3_BUCKET_DATA = args["S3BucketData"]
...
for table in response_get_tables["TableList"]:
    ...
    S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
        ...
        format="glueparquet",
        connection_options={
            "path": f"s3://{S3_BUCKET_DATA}/imdb/datalake/{table_name}/",
